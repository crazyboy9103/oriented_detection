...
class OrientedRCNN(GeneralizedRCNN):
    def __init__(
        ...
        **kwargs,
        ...
        super(OrientedRCNN, self).__init__(backbone, rpn, roi_heads, transform)
...
def oriented_rcnn_resnet50_fpn(
    ...
    **kwargs
    ...
    if version == 1:
        ...
        rpn_head = OrientedRPNHead(backbone.out_channels, rpn_anchor_generator.num_anchors_per_location()[0], conv_depth=2)
